...
if (! function_exists('autoSelect')) {
    /**
     * Buat select option
     * jadi kalo nilainya sama bakal langsung selected
     */
    function autoSelect($x = "0", $y = "1") // defaultnya sngaja dibikin false
    {
        if ($x == $y) {
            $result = "SELECTED";
        } else {
...
if (! function_exists('autoChecked')) {
    /**
     * Buat radio button
     * jadi kalo nilainya sama bakal langsung checked
     */
    function autoChecked($x = "0", $y = "1") // defaultnya sngaja dibikin false
    {
        if ($x == $y) {
            $result = "CHECKED";
        } else {
...
if (! function_exists('userPhoto')) {
     ...
     * jadi kalo nilainya sama bakal langsung checked
     */
    function userPhoto($img = 'guru.png') // defaultnya sngaja dibikin false
    {
        $folderPath = 'uploads/foto/' ;
        $imgSource = url($folderPath . $img);
        return $imgSource;
    }
}
...
if (! function_exists('url_now')) {
     ...
     * jadi kalo nilainya sama bakal langsung checked
     */
    function url_now() // defaultnya sngaja dibikin false
    {
...
if (! function_exists('getEnum')) {
    /**
     * Ngambil semua value yg terdapat di kolom enum
     * 
     */
    function getEnum($model, $column) // kelas model dan kolom
    {
        $name = $column;
        $instance = $model; // create an instance of the model to be able to get the table name
